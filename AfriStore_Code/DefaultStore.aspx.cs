...
public partial class DefaultStore : System.Web.UI.Page
{
    ...
    public static List<GetData1> GetSroreCategoryData(string ZoneCode)
    {
    ...
    //--GetStoreBrandData
    [System.Web.Services.WebMethod]
    public static List<GetStoreBrand> GetStoreBrandData(string ZoneCode)
    {
        using (SqlConnection con = new SqlConnection(CommonFunctions.connection.ToString()))
        {
            SqlDataAdapter da = new SqlDataAdapter();
    ...
    //--GetLineChart
    [System.Web.Services.WebMethod]
    public static List<GetData2> GetSroreLineChart(string ZoneCode)
    {
        using (SqlConnection con = new SqlConnection(CommonFunctions.connection.ToString()))
        {
            SqlDataAdapter da = new SqlDataAdapter();
