<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmFreeHoldItem.aspx.cs" Inherits="AfriStore_Code.frmFreeHoldItem" %>
...
<ContentTemplate>  
    ...
    <div  class="emov-header-page-title emov-header-page-title-table-vigo"   id="emov-application-title">
        <h3 style="font-size:25px;" class="emov-applications-title">Free Block Items Details</h3>
        <!-- Total Count-->
    ...
    <tr> 
    <td><input type="text" id="txtSearch" runat="server" class="emov-a-header-input" placeholder="Barcode No." /></td>
    <td></td>
...
<asp:Panel ID="pnlFreeHold" runat="server"  class="emov-page-main emov-page-main-no-top-padding" width="100%"    style="display:none;">    
  ...
  <div class="emov-a-rc-table-cover">                          
    ...
    <div style="overflow-x:scroll; text-align:center">
       <%-- ----%>
        <asp:GridView ID="grdFreeHold" runat="server" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="False" Border="0px" BorderColor="White" CssClass="emov-a-table-data" 
         PageSize="10" ShowHeaderWhenEmpty="true" Width="100%" OnPageIndexChanging="grdFreeHold_PageIndexChanging"  >
        <AlternatingRowStyle />
        <Columns>
        ...
        <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="Hold Quantity">
        <ItemTemplate>
        <asp:Label ID="lblHoldQunatity" runat="server" Text='<%# Bind("Hold_Quantity") %>'></asp:Label>
        </ItemTemplate>
        ...
        <ItemTemplate>
        <asp:Label ID="lblCreateON" runat="server" Text='<%# Bind("CreateON") %>'></asp:Label>
        </ItemTemplate>
        <ItemStyle HorizontalAlign="Left" />
        </asp:TemplateField>      
        ...
        <asp:Button ID="BtnFreeItem" runat="server" Text="FREE" Visible="true" class="login-btn"   style="float: right;"    OnClick="BtnFreeItem_Click"/>   
...
<Triggers>
<asp:AsyncPostBackTrigger ControlID="BtnFreeItem" EventName="Click" /> 
</Triggers>
</asp:UpdatePanel>
